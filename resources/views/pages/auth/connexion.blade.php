            ...
            <div class="card shadow-sm p-4">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <img src="{{ asset('assets/img/22_a9ad743c.jpg') }}" alt="Logo" class="img-fluid mb-3"
                            style="width: 100px;">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('inscription') }}" class="text-success text-decoration-none">Mot de passe
                                oublié ?</a>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="text-muted mb-0">Pas encore de compte ?
                                <a href="{{ route('inscription') }}" class="text-success text-decoration-none">Créer un
                                    compte</a>
                            </p>
                        </div>
                    </form>
